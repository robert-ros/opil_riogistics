...
class SocketSAN:
    ...
    def __init__(self):
        ...
        self.opil_san_sensors_flag = rospy.Service('opil_san_sensors/trigger_'+str(self.id), Trigger, self.callback_opil_san_sensors_trigger)
    ...
    def trigger_opil_san_sensors(self):
    ...
    def callback_opil_san_sensors_trigger(self, req):

        result = TriggerResponse()
        result.message, result.success = self.trigger_opil_san_sensors()
        return result
